...
import spinnerImg from '../../../public/logo/spinner.gif';
import sort from '../../../public/logo/sort.png';
    ...
    <>
      <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
        ...
        {products && <Col xs="1" sm="1">
          <img src={sort} className="prod-sort" alt="Sort Product order" onClick={changeSortOrder}/>
        </Col>}
      </Form.Group>
      {!products ? <img src={spinnerImg} className="prod-list-spinner" alt="Loader" /> : 
